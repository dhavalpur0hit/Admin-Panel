<?php
     ...
     if(loggedin()){
				...
				if(isset($_POST['title'])){
					$title= $_POST['title'];
					if(!empty($title)){
						 $query="delete from notice where title='".mysql_real_escape_string($title)."'";
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        ...
                        <ul id="demo" class="collapse active">
                            <li>
                                <a href="Add.php">Add<br>Notice/Announcement</a>
                            </li>
                            <li class="active">
                                <a href="#">Delete Notice/Announcement</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Delete <small>Notice/Announcement</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> <a href="main.php">Dashboard</a> / <i class="fa fa-fw fa-edit"></i> Delete
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <form action="Delete.php" method="POST">
								<div class="form-group">
									<label>Enter Title Of Notice/Announcement To Delete</label>
							...
							<?php
								...
								if($emp==1){
									echo '<div class="alert alert-info" style="width:300px">Please Enter Title</div>';
								}
								else if($success==1){
									echo '<div class="alert alert-success" style="width:300px">Notice Successfully Deleted</div>';
								}
                                else if($fail==1){
									 echo '<div class="alert alert-warning" style="width:300px">Please Enter Valid notice title</div>';
								}    
							?>
                        </div>
                        <!-- /.panel-body -->
