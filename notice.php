    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="notice.php">Admin</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Notices <small>And Announcement</small>
                        </h1>                      
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> <a href="main.php">Dashboard</a> / <i class="fa fa-bell fa-fw"></i> Notices
                        </div>
                        <!-- /.panel-heading -->
					...
					if(mysql_query($nquery)){
					  $run_query=mysql_query($nquery);
						...
						if($i<=4){
							...
							$description=mysql_result($run_query,$i,'description');
									...
									if($log==1){
											...
											if(mysql_query($nquery)){
												...
												if(mysql_num_rows($run_query)==NULL){
														...
														while($i<mysql_num_rows($run_query)){
															$title=mysql_result($run_query,$i,'title');
															echo '<a href="#" class="list-group-item"><i class="fa fa-fw fa-edit"></i>'
																	.$title.'
																	</a>';
																$i=$i+1;
														}
