     ...
     if(loggedin()){
				...
				if(isset($_POST['title']) && isset($_POST['description'])){
					...
					if(!empty($title)&& !empty($description)){
						 $query="insert into notice values('','".mysql_real_escape_string($title)."','".mysql_real_escape_string($description)."')";
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        ...
                        <ul id="demo" class="collapse">
                            <li class="active">
                                <a href="#">Add<br>Notice/Announcement</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Add <small>Notice/Announcement</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-clock-o fa-fw"></i> <a href="main.php">Dashboard</a> / <i class="fa fa-fw fa-edit"></i> Add
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
							<form action="Add.php" method="POST">
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="5" placeholder="Enter text" name="description"></textarea>
								</div>
								<input type="submit" value="Add" class="btn btn-lg btn-primary">	
							</form><br>
							<?php
								global $emp,$success,$fail;
								if($emp==1){
									echo '<div class="alert alert-info" style="width:300px">Please Enter Title And Description</div>';
								}
								else if($success==1){
									echo '<div class="alert alert-success" style="width:300px">Notice Successfully Added</div>';
								}
								else if($fail==1){
									 echo '<div class="alert alert-warning" style="width:300px">'.mysql_error().'</div>';
								}
							?>
						</div>
                        <!-- /.panel-body -->
